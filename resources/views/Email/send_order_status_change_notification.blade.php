...
<table style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px;">
    <tr>
        <td style="text-align: center; padding: 20px;">
            <h2 style="color: #333333;">Order Confirmation from adamsvibe.com</h2>
        </td>
    </tr>
    <tr>
        <td style="padding: 20px;">
            ...
            <h4>Payment Status: {{ $payment_status_name }}</h4>
            <h4>Order Status: {{ $order_status_name }}</h4>
            ...
            <p>If you have any questions about your order, feel free to contact our customer support at
                shop@adamsvibe.com</p>
            <p>Thank you for shopping with us!</p>
            <p>Best regards,<br>Adams Vibe</p>
        </td>
    </tr>
    <tr>
