...
use App\Models\VendorTranasction;
...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = [
                ...
                'subject' => "Adams Vibe: Order Placing Notification",
            ];
            ...
            //     'cli' => $cli,
            //     'messagetype' => '1',
            //     'message' => "order confirmation from adamsvibe.com\nyour order id:".$order->id."\nOrder Status: pending\nPayment Status: Unpaid\nTotal Amount: ".$order->grand_total,
        ...
        try {
            ...
            app('db')->transaction(function () use ($id, $request) {
                ...
                $data = [
                    'name' => optional($order->customer)->name,
                    'email' => optional($order->customer)->email,
                    'subject' => "Adams Vibe: Order Status Changed",
                ];
    ...
    public function makePayment(Request $request)
    {
        try {
            ...
            $post_data['tran_id'] = "adamsvibe" . uniqid();
    ...
    public function debit(Request $request)
    {
        ...
        try {
            $query = VendorTranasction::query();
            $query->where('vendor_id', Auth::id());
            $query->where('voucher_type', 'Debit');
            $query->orderBy('created_at', 'desc');
    ...
    public function credit(Request $request)
    {
        try {
            $query = VendorTranasction::query();
            $query->where('vendor_id', Auth::id());
            $query->where('voucher_type', 'Credit');
            $query->orderBy('created_at', 'desc');
    ...
    public function getAllTransaction(Request $request)
    {
        ...
        try {
            $query = VendorTranasction::where('vendor_id', Auth::id());
            $query->orderBy('created_at', 'desc');
